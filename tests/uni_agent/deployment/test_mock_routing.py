"""Routing tests for MockRuntime: bash command string -> route key.

MockRuntime is the CPU-only sandbox stub used for performance testing
(LLM real, sandbox mocked). The router decides which representative
